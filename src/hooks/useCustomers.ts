...
export function useCustomers() {
  ...
  const createCustomer = useCallback(async (form: ICustomerForm): Promise<boolean> => {
    try {
  ...
  const updateCustomer = useCallback(async (id: string, form: Partial<ICustomerForm>): Promise<boolean> => {
    try {
  ...
  return { customers, total, totalPages, loading, fetchCustomers, createCustomer, updateCustomer, deleteCustomer };
}